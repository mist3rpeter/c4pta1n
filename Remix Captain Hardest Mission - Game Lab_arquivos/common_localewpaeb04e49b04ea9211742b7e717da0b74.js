...
(window.locales = window.locales || {}).common_locale = {
  ...
  additionalInformationText: function(d) { return "For more information, see [" + d.externalDocumentationUrl + "](" + d.externalDocumentationUrl + ")"; },
  ...
  enablePeerFeedback: function(d) { return "Enable Peer Feedback?"; },
  enablePeerFeedbackDescription: function(d) { return "When peer feedback is enabled, students may leave comments on other projects in the Review section."; },
